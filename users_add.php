              ...
              <form action="add-user.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="number" name="txtNumber" id="phoneNumber" class="form-control form-control-lg" required />
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-outline">
                      <input type="password" name="txtPass" id="pass" class="form-control form-control-lg" required />

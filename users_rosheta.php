...
$result=mysqli_query($con,"SELECT patient.id as rosheta_id, patient.code , patient.date , patient.prescription ,users.name as user_name, users.date_of_birth as user_birth_date, users.number as user_number
    ...
    if($result->num_rows >0){
        ...
        while($row=mysqli_fetch_assoc($result)){
                echo"<tr>
                        ...
                        <td><a href=delete-rosheta.php?rID=".$row['rosheta_id'].">expire</a></td>
                    </tr>";
        }
